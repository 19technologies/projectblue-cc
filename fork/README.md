# Project Blue — fork.projectblue.cc

> **Project Blue fork** of [freeman-jiang/beatsync](https://github.com/freeman-jiang/beatsync) (MIT). The engine is unchanged; the design system is overridden in `apps/client/src/app/globals.css` and the visible branding is swapped to Project Blue. See [DEPLOYMENT.md](./DEPLOYMENT.md) for the Fly.io deploy runbook.
